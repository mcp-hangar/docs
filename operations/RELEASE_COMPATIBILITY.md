...
> `charts/mcp-hangar-operator 0.12.2` from GHCR and inspecting their contents, not
...
| --- | --- | --- | --- |
| `1.5.x` | `0.12.2` | `0.13.3` / `0.12.2` | `1.25` -- `1.36` |
...
| Chart `charts/mcp-hangar-operator` (appVersion `0.12.2`) | `0.12.2` | `sha256:af5786f24d9c9f2a30e82d499eaf60ac2472f17a1118acfb59661054f442da13` | ✅ |
