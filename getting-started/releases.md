...
The stable Python core is **2.1.2**, released 2026-08-02 — a plain `pip install
...
```bash
pip install mcp-hangar                # 2.1.2, the current stable release
pip install "mcp-hangar==2.1.2"       # pin it explicitly
```
